...
#define LID_DOCKED_ACTIVE_ON_AC "lid-docked-active-on-ac"
#define DEFAULT_LID_DOCKED_ACTIVE_ON_AC FALSE
#define LID_DOCKED_ACTIVE_ON_BATTERY "lid-docked-active-on-battery"
#define DEFAULT_LID_DOCKED_ACTIVE_ON_BATTERY FALSE
